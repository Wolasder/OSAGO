...
export class DriversTableComponent {
  ...
  @Output() public changeDriverInput: EventEmitter<{driver: DriverModel; index: number}> = new EventEmitter<{driver: DriverModel; index: number}>();
...
// export class DriversTableComponent {
//
//   public tableName:string = 'Поле не заполнено'
//
// }
